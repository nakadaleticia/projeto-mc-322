...
public abstract class Robo implements Entidade {
    public String nome; // modificado para protected
    ...
    public void adicionarSensor(Sensor sensor) {
        sensores.add(sensor);
        System.out.println("Sensores.Sensor adicionado com sucesso em " + this.nome);
    }
    ...
    /* Métodos obrigatórios da interface Interfaces.Entidade */
    ...
    // atualizar posição (usado pelo Ambiente.Ambiente)
